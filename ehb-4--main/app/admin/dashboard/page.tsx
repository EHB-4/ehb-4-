    ...
    <div className="min-h-screen bg-gray-100">
      <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          ...
          {/* Complaint Escalation AI Panel */}
          <div className="mt-12">
            <h2 className="text-2xl font-bold mb-4">Complaint Escalation AI</h2>
            <Suspense fallback={<div>Loading complaint escalation panel...</div>}>
              {/* Dynamically import to avoid SSR issues if any */}
              {typeof window !== 'undefined' && (
                require('@/components/admin/ComplaintEscalationPanel').default ? (
                  <div>
                    {React.createElement(require('@/components/admin/ComplaintEscalationPanel').default)}
                  </div>
                ) : null
              )}
            </Suspense>
