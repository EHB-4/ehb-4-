...
const educationServices = [
    ...
    },
    {
      ...
      description: 'English and foreign language training',
      investment: '$100K - $300K',
      roi: '18-28%',
      popularity: 95,
    },
    ...
    },
    {
      ...
      description: 'SAT, ACT, GRE, GMAT preparation',
      investment: '$80K - $250K',
      roi: '16-24%',
      popularity: 88,
    },
    {
      ...
      description: 'Preschool and daycare services',
      investment: '$200K - $500K',
      roi: '14-22%',
      popularity: 85,
    },
    {
      ...
      description: 'Skills-based training and certification',
...
const support = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50">
      ...
      <div className="relative overflow-hidden bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Shape the future through education with EHB's comprehensive education and training
              franchise opportunities. Build a legacy while creating profitable learning centers.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/franchise/apply?category=education"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-purple-100">Industry Size</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="text-purple-100">Active Franchises</div>
            </div>
            <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Education & Training Services</h2>
          <p className="text-lg text-gray-600">
            Choose from our comprehensive range of educational franchise opportunities
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {educationServices.map((service, index) => (
            ...
            >
              ...
              <Link
                href={`/franchise/apply?category=education&service=${service.name}`}
                className="inline-flex items-center justify-center w-full px-4 py-2 bg-purple-600 text-white font-medium rounded-lg hover:bg-purple-700 transition-colors"
              >
                Apply Now
                <ArrowRightIcon className="ml-2 h-4 w-4" />
              </Link>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                {support.map((item, index) => (
                  <div key={index} className="flex items-start">
                    <CheckCircleIcon className="h-6 w-6 text-purple-500 mt-0.5 mr-3 flex-shrink-0" />
                    <span className="text-gray-700">{item}</span>
                  </div>
                ))}
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Investment Options</h2>
          <p className="text-lg text-gray-600">
            Choose the investment level that fits your educational goals
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h3 className="text-xl font-bold text-gray-900 mb-4 text-center">Starter</h3>
            <div className="text-center mb-6">
              <div className="text-3xl font-bold text-green-600">$80K - $200K</div>
              <div className="text-gray-600">Initial Investment</div>
            </div>
            <ul className="space-y-3">
              <li className="flex items-center">
          ...
          <div className="bg-white rounded-xl shadow-lg ring-2 ring-purple-500 p-6 scale-105">
            <div className="text-center mb-2">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4 text-center">Professional</h3>
            <div className="text-center mb-6">
              <div className="text-3xl font-bold text-purple-600">$200K - $500K</div>
              <div className="text-gray-600">Initial Investment</div>
            </div>
            <ul className="space-y-3">
              <li className="flex items-center">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h3 className="text-xl font-bold text-gray-900 mb-4 text-center">Enterprise</h3>
            <div className="text-center mb-6">
              <div className="text-3xl font-bold text-blue-600">$500K - $2M</div>
              <div className="text-gray-600">Initial Investment</div>
            </div>
            <ul className="space-y-3">
              <li className="flex items-center">
      ...
      <div className="bg-purple-600 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-purple-100 mb-8">
            Join our network of successful education franchise owners
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/franchise/apply?category=education"
            ...
            <Link
              href="/franchise/status"
              className="inline-flex items-center px-8 py-4 bg-transparent text-white border-2 border-white font-semibold rounded-lg hover:bg-white hover:text-purple-600 transition-colors"
            >
              Check Application Status
              <ClockIcon className="ml-2 h-5 w-5" />
            </Link>
...
export default EducationFranchisePage;