        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
          ...
          <div className="mt-4 md:mt-0">
            <div className="flex items-center space-x-4">
              <div className="text-sm text-gray-500">Founded: {companyInfo.founded}</div>
              <div className="text-sm text-gray-500">HQ: {companyInfo.headquarters}</div>
            </div>
          </div>
        </div>
            ...
            <div className="mt-2 space-y-2">
              {companyInfo.techStack.map(tech => (
                <div key={tech.id} className="bg-gray-50 p-3 rounded-lg">
                  ...
                  <div className="mt-1 text-xs text-gray-500">Version: {tech.version}</div>
                </div>
              ))}
            </div>
          </div>
