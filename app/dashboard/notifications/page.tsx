...
import { showNotification, markAsRead, deleteNotification, markAllAsRead, type Notification } from '@/lib/notifications';
                ...
                <div className="flex items-start justify-between">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      ...
                      {notification.type === 'destructive' && <AlertCircle className="h-4 w-4 text-red-500" />}
                      {notification.type === 'default' && <Info className="h-4 w-4 text-blue-500" />}
