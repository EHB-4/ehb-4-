...
const AIAgentTools: React.FC = () => {
  ...
  const [selectedModule, setSelectedModule] = useState<'security' | 'performance' | 'system'>(
    'system'
  );
              ...
              <div className="flex space-x-2">
                {['security', 'performance', 'system'].map(module => (
                  <button
                    key={module}
                    onClick={() =>
                      setSelectedModule(module as 'security' | 'performance' | 'system')
                    }
            ...
            {[
              ...
              <button
                ...
                className={`px-3 py-2 rounded ${
                  activeTab === id ? 'bg-blue-500 text-white' : 'text-gray-600 hover:bg-gray-100'
                }`}
              >
                {label}
              </button>
