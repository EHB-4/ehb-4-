...
var accessibilityFixes = [
  ...
  // Form element label fixes
  {
    ...
    fix: function (match, p1) {
      ...
      return '<label for="'
        .concat(id, '">Input field</label><input')
        .concat(p1, ' id="')
        .concat(id, '">');
    },
  },
  // Select element accessibility fixes
  {
    ...
    fix: function (match, p1) {
      var id = Math.random().toString(36).substring(7);
      return '<label for="'
        .concat(id, '">Select option</label><select')
        .concat(p1, ' id="')
        .concat(id, '">');
    },
  },
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          // Apply each fix
          for (
            _i = 0, accessibilityFixes_1 = accessibilityFixes;
            _i < accessibilityFixes_1.length;
            _i++
          ) {
          ...
          cssFileName =
            path_1.default.basename(filePath, path_1.default.extname(filePath)) + '.module.css';
...
function main() {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        case 0:
          return [4 /*yield*/, findFiles('./app/**/*.{tsx,jsx}')];
        case 1:
          files = _d.sent();
